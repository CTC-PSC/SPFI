...
author: "Last updated by Randy Peterson"
date: "Last updated on October 2, 2018"
output:
...
```{r include=FALSE}
#note that i load the data first b/c i've made a number of changes to some of hte functions that are loaded upon loading this data
...
2. Create a SPFI Input Object
  ...
  c. ERA fisheries that are to be used to compute the SPFI
...
## Running the program
### Computing the SPFI
All that's left is actually computing the SPFI, which is easily done via the spfi function:
